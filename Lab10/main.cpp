...
// Employee
  ...
  Employee* Dan = new Hourly("Dan", 8.78);
  Employee* Alex = new Hourly("Alex", 10.23);
  // Employeee
  Employee* Harold = new Executive("Harold", 17.99);
  Arr[0] = Jen;
  Arr[1] = Dan;
  Arr[2] = Alex;
  Arr[3] = Harold;
...
// Still needs fixing.
// Cant make employee look like an Hourly
// But can make Hourly an employees
